          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <ul className="list-inline-item mt-4 mb-5">
                Worked as a front-end developer in the Marketo development team, a part of Adobe Digital Experience. During my time, I continuously practiced of producing TypeScript, JavaScript and HTML&CSS code to delivering intuitive and enjoyable user experiences on Marketo website. I successfully produced 'clean' code and wrote unit tests to prevent possible bugs, ensure availability and high performance of features and keep the code readable for other developers.
                <li className='fst-italic'>
                Technical Exposure: ReactJS + REDUX, TypeScript, JavaScript, HTML, CSS, Jest framework, Git, Jenkins.
                </li>
              </ul>
            </div>
          </div>
