        ...
        <div className="content">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              Worked as a DevOps engineer at Citigroup. At Citi, I was part of the Devops team helped to build the Developer Portal, which is a single global platform where Citi exposes its APIs to 3rd parties, who can contract with Citi and become Partners. Those Partners will have their applications registered in the production environment of Citi. With proper authorization depending on the API types and nature of the application, Citi's Partners are able to connect and access data directly from the Citibank.
              <li className='fst-italic'>
                Technical Exposure: AWS S3, DynamoDB, Lambda, API Gateway, Java, JUnit, Spring Boot Framework, Mockito.
              </li>
              </ul>
            </div>
          </div>
